...
typealias NotificationOnCilck = (match: MatchDomain) -> Unit

@Composable
fun MainScreen(matches : List<MatchDomain>, onNotificationClick: NotificationOnCilck) {
...
@Composable
fun MatchInfo(match: MatchDomain, onNotificationClick: NotificationOnCilck) {
...
@Composable
fun Notification(match: MatchDomain, onClick: NotificationOnCilck) {
